...
def make_param_card(mMed, mDM, output_path):
    ...
    template_text = template_text.format(AMASS=mMed, AWIDTH=med_width, CHIMASS=mDM)
...
def main():
    parser = argparse.ArgumentParser(
        description='Create directories for each mMed, mDM combination that holds appropriate cards.')
